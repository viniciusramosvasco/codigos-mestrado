...
%% Fluxos totais
phi1 = (n/N)*((R2 + R3)*i1 + R3*i2 + R2*i3); %alteração sentido i3
phi2 = (n/N)*(-R3*i1 -(R1+ R3)*i2 + R1*i3); %alteração sentido i3
phi3 = (n/N)*(-R2*i1 +R1*i2 -(R1 + R2)*i3); %alteração sentido i3
